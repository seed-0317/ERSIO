...
insert into ERSIO.ers_users (u_username, u_firstname, u_lastname, u_email, ur_id) values (‘sss123’, ‘Sarah’, ‘White’,   ‘sarah@ersio.com’, 1 );
insert into ERSIO.ers_users (u_username, u_firstname, u_lastname, u_email, ur_id) values (‘jjj123’, ‘John’,  ‘Smith’,   ‘john@ersio.com’,  1 );
insert into ERSIO.ers_users (u_username, u_firstname, u_lastname, u_email, ur_id) values (‘bbb123’, ‘Brian’, ‘Green’,   ‘brian@ersio.com’, 1 );
insert into ERSIO.ers_users (u_username, u_firstname, u_lastname, u_email, ur_id) values (‘ttt123’, ‘Tom’,   ‘Brown’,   ‘tom@ersio.com’,   2 );
insert into ERSIO.ers_users (u_username, u_firstname, u_lastname, u_email, ur_id) values (‘ddd123’, ‘David’, ‘Johnson’, ‘david@ersio.com’, 2 );
